...
class ProvinceJudiciary(BaseModel):
    court = models.ForeignKey(ProvinceJudiciaryOffice, on_delete=models.DO_NOTHING, null=True)
    last_modified_by = models.ForeignKey(User, on_delete=models.DO_NOTHING, related_name='pro_jud_last_modified_by',
                                         null=True,
                                         blank=True)
    select_province = models.ForeignKey(ProvincesName, on_delete=models.DO_NOTHING, null=True)
